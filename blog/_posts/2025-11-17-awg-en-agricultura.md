...
## 1. Por qué es tan importante actuar

### ✔ Aumento del estrés hídrico agrícola
...
## 4. Cambio climático y la creciente relevancia de los AWG

- Las **sequías son más largas** → los acuíferos ya no se recuperan entre temporadas.
- Las **lluvias son más irregulares** → la captación pluvial es menos confiable.
- Las **temperaturas más altas** secan el suelo más rápido.
- Los **eventos extremos** dañan infraestructura tradicional → los AWG son resistentes y modulares.

En regiones donde ya no se puede depender solo de la lluvia o de los mantos acuíferos, los AWG —especialmente los **higroscópicos o híbridos**— se vuelven una herramienta clave para:
- sostener cultivos,
- establecer huertos nuevos,
- aumentar la resiliencia de comunidades rurales,
- reducir la vulnerabilidad económica ante sequías severas.
...
El par más común es agua–amoniaco; el agua absorbe NH₃ en la zona fría y luego el calor externo separa el refrigerante.
...
### Aplicación en AWG
Adecuado cuando se dispone de calor gratuito o renovable.  
Aunque no es el más eficiente, puede ser muy económico en operación.
...
### Funcionamiento
Utiliza un compresor para presurizar un refrigerante (R134a, R410A, R32, CO₂).  
El ciclo es: compresor → condensador → válvula de expansión → evaporador.
...
### Aplicación en AWG
Es la tecnología dominante en sistemas industriales (50–10,000 L/día).  
Adecuado para altas temperaturas y grandes volúmenes de aire.
...
### Funcionamiento
Un módulo Peltier desplaza calor de un lado al otro usando únicamente electricidad.
...
### Ventajas
- Opera en humedades muy bajas.
- Puede usar energía solar térmica.
- Silencioso y de bajo mantenimiento.

### Desventajas
- El proceso puede no ser continuo.
- Menor producción por kg de material.
...
### Funcionamiento
Combinan materiales adsorbentes con condensación mecánica o termoeléctrica.
...
### Desventajas
- Diseño más complejo.
- Materiales avanzados pueden aumentar el costo.
- Algunos ciclos requieren etapas de regeneración.

### Aplicación en AWG
La tecnología más prometedora para regiones con sequías severas y humedades extremadamente bajas.



## 6. Comparación General de Tecnologías AWG

| Tipo            | Energía                        | Eficiencia | HR mínima | Escalabilidad | Ideal para |
|-----------------|--------------------------------|------------|-----------|----------------|------------|
| Absorción       | Calor                           | Media      | >40%      | Media          | Solar térmico, calor residual |
| Compresión      | Eléctrica                       | Alta       | >40%      | Muy alta       | AWG industriales |
| Termoeléctrica  | Eléctrica                       | Baja       | >50%      | Baja           | Equipos pequeños y solares |
| Higroscópicos   | Solar térmica o eléctrica       | Media      | 20–40%    | Media          | Zonas áridas |
| Híbridos        | Mixta                           | Muy alta   | <20%      | Media–alta     | AWG avanzado de alta eficiencia |
...
condiciones atmosféricas HR de la región y la implementación
específica del tipo de sistema AWG.*
